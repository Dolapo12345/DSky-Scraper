...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  var trueWidth = 704;
  var trueHeight = 448;
  var scaleX = windowWidth / trueWidth;
  var scaleY = windowHeight / trueHeight;
  var scaleGame = Math.min(scaleX, scaleY);
  var firstSpawned = false;
  var firstAnvil = false;
  ...
  __name(gameOverScreen, "gameOverScreen");
  ...
  __name(spawnClothesLine, "spawnClothesLine");
  function dropAnvil() {
  ...
  __name(dropAnvil, "dropAnvil");
  scene("game", (fromPrevGame, a2, b2) => {
    let score = 0;
    let loopLevel = 0;
    let gameOver = false;
    let introMusPlaying = a2;
    let gameMusicPlaying = b2;
    let health = 3;
  ...
  scene("mainMenu", () => {
    ...
    startButton.onClick(() => {
      ...
      wait(0.9, () => {
        ...
        var introJumpRight2 = true;
        if (introJumpRight2 == true) {
          onUpdate(() => {
